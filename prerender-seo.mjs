...
function writeRobotsTxt() {
  // Single source of truth: public/robots.txt
  fs.copyFileSync(path.join(process.cwd(), 'public', 'robots.txt'), path.join(distDir, 'robots.txt'));
  log('robots.txt → copied from public/robots.txt');
}
