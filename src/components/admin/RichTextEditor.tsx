...
export default function RichTextEditor({
  ...
  const editor = useEditor({
    ...
    editorProps: {
      attributes: {
        class:
          "prose prose-invert max-w-none min-h-[260px] sm:min-h-[360px] focus:outline-none px-3 py-3 text-sm leading-relaxed",
      },
    },
  ...
  return (
    <div className={cn("rounded-md border border-primary/40 bg-gray-800/60 backdrop-blur", className)}>
      <div className="flex flex-wrap items-center gap-0.5 border-b border-border/40 p-1.5 sticky top-0 bg-gray-800/90 backdrop-blur z-10 rounded-t-md">
