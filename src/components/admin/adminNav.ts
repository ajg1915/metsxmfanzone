...
export const ADMIN_NAV: AdminNavSection[] = [
  ...
  },
  {
    ...
    icon: Mic,
    items: [
      { title: "Management", url: "/admin/podcasts", icon: Mic },
      { title: "Clubhouse Studio", url: "/admin/studio", icon: Radio },
      { title: "Outlines", url: "/admin/podcast-outlines", icon: ClipboardList },
  ...
  },
  {
    ...
    icon: Settings,
    items: [
      { title: "User Directory", url: "/admin/user-management", icon: Users },
